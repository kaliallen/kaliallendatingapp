...
exports.FirestoreTransaction = exports.FirestoreStorage = void 0;
...
let FirestoreStorage = FirestoreStorage_1 = class FirestoreStorage {
    ...
    query(collection, cb) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return result.docs.map((document) => {
                return FirestoreStorage_1.format(document);
            });
        });
    }
    ...
    internalUpdate(collection, id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const path = FirestoreStorage_1.getPath(collection, id);
            const docRef = yield this.firestore.doc(path);
